...
public class RBWrapper: NSObject {
	...
	internal var recordHaveResume: Bool = false
...
extension RecordKit {
	...
	public static func recordEndUp(_ ctx: RBContextPt) {
		...
		ctx.wrapper.asrResult = RBRecdAsr.default.asrer.finalResult ?? RBRecdAsr.default.asrer.chunkResult ?? RBRecdAsr.default.asrer.flushResult ?? ""
		RBRecdAsr.default.asrer.finalResult = ""
		RBRecdAsr.default.asrer.chunkResult = ""
		RBRecdAsr.default.asrer.flushResult = ""
	...
	public static func recordResume(_ ctx: RBContextPt) {
		RecordKit.shouldBeRunning = true
		ctx.wrapper.recordHaveResume = true
		RBRecdAsr.default.recorder.record(ctx)
		ctx.wrapper.recordHaveResume = false
		RBRecdAsr.default.asrer.longSpeechRecognition()
